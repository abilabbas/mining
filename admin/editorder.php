...
<!--info end--> 
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form action="proses_editorder.php" method="POST" class="needs-validation" novalidate>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['id_member'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['nama'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['email'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['alamat'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['nohp'] ?>" readonly>
         ...
         <div class="form-group row">
          ...
          <select name="status" class="custom-select" id="inputGroupSelect02">
                    <option selected value="1">OnProgress</option>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['dateorder'] ?>" readonly>
        ...
        <div class="form-group row">
                ...
                <div class="col-sm-10">   
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" value="<?php echo $order['alamatorder'] ?>" readonly></textarea>
                </div>
        </div>
        ...
        <h4 class="mb-3">Detail Produk</h4>
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['produk_name'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $order['payment_name'] ?>" readonly>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" id="disabledTextInput" class="form-control" value="Rp. <?php echo $order['produk_price'] ?>" readonly>
...
-->
        <div class="form-group row">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
               <button name="updateorder" value="updateorder" class="btn btn-primary btn-lg btn-block" type="submit">Simpan</button>
              </div>
            </div>   
